...
export default function PerangkatPage() {
  ...
  const T = {
    ...
    subtitle: { id: 'Kesehatan & konektivitas', en: 'Health & connectivity' },
    loading:  { id: 'Memuat perangkat...',      en: 'Loading devices...' },
    ...
    lastSeen: { id: 'Terakhir Aktif',           en: 'Last Seen'         },
    firmware: { id: 'Firmware',                 en: 'Firmware'          },
    backup:   { id: 'SD Backup',                en: 'SD Backup'         },
        ...
        <div className="flex items-center justify-between flex-wrap gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={fetchDevices} aria-label="Refresh"
              className="flex items-center justify-center w-9 h-9 rounded-xl hover:bg-gray-100 text-gray-400 transition-colors">
          ...
          <div className="space-y-4">
            ...
            {node && (
              <div className="card overflow-hidden"
                ...
                {/* Node info — klik header untuk expand kontrol */}
                <div className="p-4">
            ...
            {gateway && (
              <div className="card p-4"
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
                  <InfoRow
                    ...
                    value={gateway.last_rssi != null
                      ? <span className="flex items-center gap-1"><Signal size={13}/>{gateway.last_rssi} dBm</span>
                      : '—'}
                ...
                <div className="mt-3 pt-3 border-t border-gray-100 flex flex-wrap gap-3 text-[10px]">
                  {[
                    { color: '#22C55E', label: lang === 'id' ? 'Bagus >-90 dBm'   : 'Good >-90 dBm'   },
                    { color: '#F59E0B', label: lang === 'id' ? 'Lemah -90~-110'    : 'Weak -90~-110'   },
